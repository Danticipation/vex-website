...
**WebGL / cinematic marketing bar (separate from API pilot gate):** `docs/plans/2026-04-04-vex-ELITE-DIGITAL-PRESENCE-v1.md` §21+ (perf), §26–§27 (revenue / investor), §28–§30 (Cox, autonomy, production firepower); do not confuse with tenant/RBAC correctness above.
