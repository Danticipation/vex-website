...
**Marketing WebGL + luxury UX + velocity doctrine (non-blocking for pilot gate):** `docs/plans/2026-04-04-vex-ELITE-DIGITAL-PRESENCE-v1.md` (**§0–§30**): §21+ (perf), **§28.3** (Cox gap + P0 queue names), **§29** (Cursor **zero-click** background autonomy), **§30** (**Resource Arsenal** — **`NEXT_PUBLIC_HERO_VEHICLE_GLB`**, `packages/3d-configurator/assets/**`, Turbo **warm-up** one-liner, Poly Haven, Sketchfab, Spector, **`TURBO_TOKEN` / `TURBO_TEAM` / `TURBO_CACHE`**, auth + **remote-cache write** troubleshooting, **`--dry-run=text`**, CI **`quality.yml`** Turbo graph) · Crown Jewel `docs/plans/2026-04-05-vex-ELITE-DIGITAL-PRESENCE-v2.0.md` · **Apex Studio `/build`:** `docs/plans/2026-04-05-vex-apex-studio-configurator-v1.0.md`.
