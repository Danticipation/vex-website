...
- **Elite digital presence v1** (**§0–§30** single source — WebGL §21+, VLR halt, Cox §28 / §28.3, **§29** Cursor **Always** background, **§30** **`NEXT_PUBLIC_HERO_VEHICLE_GLB`** + `packages/3d-configurator/assets/**` + Turbo **warm-up** one-liner + **`turbo.json`** + **`TURBO_CACHE`**): [docs/plans/2026-04-04-vex-ELITE-DIGITAL-PRESENCE-v1.md](docs/plans/2026-04-04-vex-ELITE-DIGITAL-PRESENCE-v1.md)
