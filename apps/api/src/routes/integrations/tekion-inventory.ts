...
import { enqueueTekionAppraisalPush, enqueueTekionInventorySync } from "../../lib/queue.js";
import { prisma } from "../../lib/tenant.js";

export const tekionInventoryRouter: Router = Router();
...
tekionInventoryRouter.post(
  ...
  async (req, res) => {
    ...
    await enqueueTekionAppraisalPush({
      tenantId: req.tenantId,
      externalId: body.externalId,
      payload: body.payload,
    });
